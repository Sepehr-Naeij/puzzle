...
public class Prisoner {
    ...
    public HatColor guess(ArrayList<HatColor> observation,
        ...
        for (HatColor color : list) {
            if (color.equals(HatColor.BLUE)) {
                numPrevBlue++;
            }
        }
        int numRed = 0;
